...
function createTestApp(runner, appOptions = {}) {
    return runner.runExternalSchematicAsync('@schematics/angular', 'workspace', {
        ...
        .pipe(operators_1.switchMap((workspaceTree) => {
        return runner.runExternalSchematicAsync('@schematics/angular', 'application', Object.assign({}, appOptions, { name: 'ngx-bootstrap' }), workspaceTree);
    }));
}
